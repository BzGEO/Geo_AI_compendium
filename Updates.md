...
## Updates: 25.04.2026
1. Dr. Robin Cole's [satellite-image-deep-learning](https://www.youtube.com/@satellite-image-deep-learning) video podcast series tackles [BetaEarth: Open Embeddings of Sentinel-2 and Sentinel-1](https://www.youtube.com/watch?v=1jfJjXWmoto), which is partly based on Google's [AlphaEarth Foundations](https://deepmind.google/blog/alphaearth-foundations-helps-map-our-planet-in-unprecedented-detail/) dataset. The *BetaEarth* dataset can be accessed through the following [repo](https://github.com/asterisk-labs/beta-earth) from [*Asterisk Labs*](https://github.com/asterisk-labs).
