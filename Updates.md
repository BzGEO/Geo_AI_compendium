...
3. The 2026 session of the **International Geoscience and Remote Sensing Symposium (IGARSS)** occurred in Washington, DC last week (9-14 August 2026). [Dr. Gilberto Camara](https://en.wikipedia.org/wiki/Gilberto_C%C3%A2mara), the former head of both the [**Brazilian Space Research Institute** (INPE)](https://www.gov.br/inpe/pt-br) and the inter-governmental [**Group on Earth Observations** (GEO)](https://earthobservations.org/) had thoughts on how geospatial AI is progressing / evolving, and he shared those on his LinkedIn profile: https://www.linkedin.com/posts/gilberto-camara-6782a594_igarss-2026-confirms-a-trend-i-have-previously-activity-7493789580102475776-arO8.

<img width="568" height="375" alt="image" src="https://github.com/user-attachments/assets/8f18d40c-04a0-4d61-a4ab-5018db40b994" />
...
3. More on deep fakes and EO: [Selling Trust from Orbit](https://foreignpolicy.com/2026/08/06/satellite-imagery-iran-china-space-ai-fraud-disinformation/) (*source: ForeignPolicy.com, 2026*).
...
2. On the **centralization of AI power**: [Mark Zuckerberg Blasts Centralization of A.I. Power](https://www.nytimes.com/2026/07/28/technology/mark-zuckerberg-meta-ai.html) (*paywalled*) (*source: the New York Times, 2026*).
3. On the **impacts of AI on worker creativity**: [Generative AI could boost creativity, but only for some workers](https://www.fastcompany.com/91578663/generative-ai-could-boost-creativity-but-only-for-some-workers) (*source: Fast Company, 2026*).
...
1. Given that the 2026 [***Esri User Conference***](https://www.esri.com/en-us/about/events/uc/overview) is underway, there will likely be a number of articles about ***ArcGIS Pro***'s capabilities coming out on the [*ArcGIS Blog*](https://www.esri.com/arcgis-blog/overview). Recent relevant articles include the following:
   * [An Introduction to Embeddings for GIS Analysts](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/an-introduction-to-embeddings-for-gis-analysts) ➡️ *focuses on embeddings*
   * [Beyond latitude and longitude: Giving geographic context to coordinates](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/beyond-latitude-and-longitude-giving-geographic-context-to-coordinates) ➡️ *focuses on embeddings*
   * [Earth Observation with Remote Sensing Foundation Models in ArcGIS](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/earth-observation-with-remote-sensing-foundation-models-in-arcgis) ➡️ *also focuses on embeddings*
   * [Every place has a fingerprint: How foundation models are learning locations](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/every-place-has-a-fingerprint-how-foundation-models-are-learning-locations) ➡️ *focuses on embeddings*
   * [Introducing the AI Assistant (Beta) on Esri.com](https://www.esri.com/arcgis-blog/products/arcgis/announcements/introducing-the-ai-assistant-beta-on-esri-com)
   * [Introducing Geospatial Foundation Models in ArcGIS](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/introducing-geospatial-foundation-models-in-arcgis) ➡️ *also focuses on embeddings*
   * [Understanding Grid Size for Geospatial Foundation Models for Image Embeddings](https://www.esri.com/arcgis-blog/products/arcgis-pro/geoai/understanding-grid-size-for-geospatial-foundation-models-for-image-embeddings) ➡️ *focuses on embeddings*
...
2. **Upcoming event:** At the [American Geophysical Union (AGU)](https://www.agu.org)'s fall 2026 [meeting](https://www.agu.org/annual-meeting), Tim Mayer of [NASA EarthRISE](https://github.com/NASA-EarthRISE) / [University of Alabama in Huntsville](https://github.com/UAH-Lab-for-Applied-Science), along with [Biplov Bhandari](https://github.com/biplovbhandari) and [David Saah](https://github.com/davidsaah) (University of San Francisco / [Spatial Informatics Group](https://github.com/sig-gis)), are hosting a [**Frontiers of Geospatial Artificial Intelligence and Capacity Building: Translating Research to Action**](https://agu.confex.com/agu/agu26/prelim.cgi/Session/279424) session. Abstracts are being accepted through 5 August 2026.
...
1. The 2nd [***ESA-NASA Workshop on AI Foundation Models for Earth Observation***](https://nikal.eventsair.com/2nd-esa-nasa-workshop-on-ai-foundation-model-for-earth-observation-eo/) - *attended by approximately 260 in-person participants and additional virtual participants* - is ongoing this week in Huntsville, Alabama (USA).
   * The **workshop's GitHub repo** is: https://github.com/NASA-IMPACT/ESA-NASA-Workshop-2026
     ...
     * The *AI for Science* page from the **agentic GeoAI** session on day 4 can be found at: https://nasa-impact.github.io/AI-Agents-for-Science/. 
       * Accompanying session introductory [slides](https://github.com/NASA-IMPACT/ESA-NASA-Workshop-2026/blob/main/Day%204/Track%201/GeoAI-Agent-Tutorial/presentations/Handson_ESA_NASA_CARE.pdf).
...
<img width="297" height="417" alt="Screenshot 2026-05-15 110633" src="https://github.com/user-attachments/assets/06a9907c-cad4-45bf-83de-58d1db4c6400" />
...
2. The following recent article from *The New York Times* [behind a paywall] offers a great primer for how deep learning and AI work, particularly through the framework of **model interpretability**: ["We Don’t Really Know How A.I. Works. That’s a Problem."](https://www.nytimes.com/2026/04/15/magazine/ai-black-box-interpretability-research.html)
   ...
   * "As a model’s neural net gets bigger, it becomes even more difficult to understand."
   * "...She is generally tired of “people who are just like, Let’s feed everything to the A.I., and it will figure it out for us”"
...
3. On ArcGIS Pro's [Deep Learning packages](https://livingatlas.arcgis.com/en/browse/#d=1&type=tool&itemTypes=Deep+Learning+Package): This is probably not the best way to track the following, but it's interesting to have a snapshot of the use of the various Prithvi sub-models for ArcGIS Pro, which have been available for just over two years. *Do the following download numbers provide insight into how many GIS users are using ArcGIS Pro for land cover classification and damage estimation?*
    ...
    * [Crop classification](https://www.arcgis.com/home/item.html?id=39e598cb9eed4f1eac28f8484c5f3679): **28,256 downloads** (since 3 Jan. 2024) ➡️ by comparison, [HuggingFace](https://huggingface.co/ibm-nasa-geospatial/Prithvi-EO-2.0-300M) indicates that there were **12,768 downloads** of the Prithvi-EO-2.0 model in the last month (*as of 30.03.2026*)
...
3. Esri provided an update on ArcGIS Pro 3.7, which is expected to be released by May 2027: https://www.esri.com/arcgis-blog/products/arcgis-pro/announcements/arcgis-pro-3-7-moves-to-net-10.
...
2. For those using the deep learning workflows in ArcGIS Pro, ArcGIS Pro version 3.6 has released its first patch (3.6.1), available from https://my.esri.com. Details are provided here: https://www.esri.com/arcgis-blog/products/arcgis-pro/administration/arcgis-pro-3-6-1-patch.
...
## Updates: 06.12.2025
1. In the GeoAI / ML space, one of the *regularly updated* sources of information is the Satellite Image Deep Learning series by [Dr. Robin Cole](https://github.com/robmarkcole). His [video podcast playlist](https://www.youtube.com/watch?v=tBnx7aJQUZE&list=PLHifi5Wnkifd5ZndO2ichD_7nnB26eDBj) was updated this week with a talk from [Julia Wąsala](https://github.com/JuliaWasala) about the detection of methane plumes using TROPOMI data.

## Updates: 03.12.2025
1. The GIS Association of Alabama (GISAA) is hosting a Friday Lunch & Learn webinar on the GeoAI Working Group (formerly under SERVIR), by [Tim Mayer](https://github.com/MayerT1) on 05.12.2025. See: https://gisaa.org/event-6388124. The recording of this will end up on the GISAA's YouTube channel (https://www.youtube.com/@gisalabama/videos).

## Updates: 14.11.2025
1. Version 3.6 of [ArcGIS Pro](https://www.esri.com/en-us/arcgis/products/arcgis-pro/overview) was released yesterday (13.11.2025). The following article details the overall updates: https://pro.arcgis.com/en/pro-app/latest/get-started/whats-new-in-arcgis-pro.htm. The following also details the specific updates related to *Image Analyst*, including new features related to revising training data for classifications, and extraction of spectral signatures, including a new format for spectral signature data: https://www.esri.com/arcgis-blog/products/arcgis-pro/imagery/whats-new-in-imagery-in-arcgis-pro-november-2025.
2. Note: It remains to be seen whether or not the new version of ArcGIS and the associated new version of the [Deep Learning tools](https://github.com/Esri/deep-learning-frameworks) (see: https://github.com/Esri/deep-learning-frameworks) will result in any tangible improvements in the time taken to perform deep learning tasks.
